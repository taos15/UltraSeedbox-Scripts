...
# Rclone upload script with optional Discord notification upon copy completion (if something is copied)
#
# Recommended for use via cron
# Use this on your local server not in your ultra slot
# For example: */10 * * * * /path/to/rclone-upload.sh >/dev/null 2>&1
# -----------------------------------------------------------------------------

SOURCE_DIR="/Stuff/Local/"
DESTINATION_DIR="remote:"

DISCORD_WEBHOOK_URL=""
DISCORD_ICON_OVERRIDE="https://i.imgur.com/MZYwA1I.png"
DISCORD_NAME_OVERRIDE="RCLONE-COPY"

LOCK_FILE="/rclone-upload-copy.lock"
LOG_FILE="/rclone-upload-copy.log"
